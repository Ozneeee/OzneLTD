Locales['fr'] = {
  ...
  ['garage_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder aux ~r~Actions Véhicule~s~.',
  ...
  ['helicopter_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder aux ~r~Actions de l\'hélicoptère~s~.',
  ...
  ['vehicleshop_bought'] = 'vous avez acheté ~r~%s~s~ pour ~r~$%s~s~',
  ...
  ['bossmanagement_title'] = 'Entreprise: BurgerShoot',
